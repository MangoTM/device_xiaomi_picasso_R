...
# Prebuilt Core
BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo22.4.img
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/boot22.4.img-zImage
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/boot22.4.img-dtb
